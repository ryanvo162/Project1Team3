...
import com.ps14483.project1_team3.adapter.Guest_TabLayoutPetAdapter;

public class Guest_PetFragment extends Fragment {
    TabLayout tabLayout;
    ViewPager viewPager;
    Toolbar toolbar;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Guest_TabLayoutPetAdapter adapter=new Guest_TabLayoutPetAdapter(getFragmentManager(), FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
